...
![Build tasks](/assets/images/p/jekyll-static-website/jek-tasks.png)
...
![Install jekyll](/assets/images/p/jekyll-static-website/jek-bash1.png)

The installation of Jekyll

![Install gems](/assets/images/p/jekyll-static-website/jek-bash2.png)

Then we build the website. Jekyll will takes the different assets and outputs the result in the _site folder
![Building the jekyll website](/assets/images/p/jekyll-static-website/jek-bash3.png)
...
![Copy files](/assets/images/p/jekyll-static-website/jek-copy.png)

And to finish, we package it as an artifact
![Building the artifact](/assets/images/p/jekyll-static-website/jek-publish.png)
...
![Release](/assets/images/p/jekyll-static-website/jek-rel1.png)
...
![Release](/assets/images/p/jekyll-static-website/jek-rel2.png)
...
![Release](/assets/images/p/jekyll-static-website/jek-rel3.png)
